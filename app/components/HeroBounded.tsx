...
...restProps
  ...
  return (
    <Comp className={clsx("w-full  h-fit flex bg-[#ECDEDE]  backdrop-filter backdrop-blur-md flex-col  items-center overflow-x-hidden  ",className)  } {...restProps} style={pontanoSans.style}>
